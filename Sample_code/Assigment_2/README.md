...
The c code is provided [here](https://github.com/ROHITKUCHERIA/Cyber-security)

##### the HTML and JavaScript code may be refered from [this git repo](https://github.com/rizkiarm/Diffie-Hellman) for your file you copy " rizkiarm/Diffie-Hellman  repo" code and run the code as per instruction given in the repo.
